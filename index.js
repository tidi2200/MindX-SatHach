...
span.onclick = function() {
  ...
  var closeNoiTai = document.getElementsByClassName("closeNoiTai")[0];

  var modalNoiTai = document.getElementById("myModal-NoiTai");
  
  // Get the button that opens the modal
  var btnNoiTai = document.querySelector("#modal-NoiTai");
  
  
  btnNoiTai.onclick = function() {
      modal1.style.display = "block";
    }
  
    // When the user clicks on <span> (x), close the modal
  closeNoiTai.onclick = function() {
